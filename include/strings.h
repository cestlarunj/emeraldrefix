...
extern const u8 gText_LevelCapRareCandy[];
extern const u8 gText_LevelCapExpCandy[];
...
extern const u8 gText_PkmnReachedLvlCap[];
...
extern const u8 gText_Fight[];
extern const u8 gText_DontFight[];
