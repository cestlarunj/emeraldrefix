...
#define FLAG_ITEM_ROUTE_111_SMOOTH_ROCK                             0x493
#define FLAG_ITEM_ROUTE_111_PP_UP                                   0x494
...
#define FLAG_PETALBURG_MART_SECOND_CLERK            (SYSTEM_FLAGS + 0x83) // CUSTOM EMERALDREFIX / set = no second clerk in PetalBurg
