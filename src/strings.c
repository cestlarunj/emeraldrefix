...
const u8 gText_Var1NuzlockePrevents[] = _("It's impossible to\nuse {STR_VAR_1}\nduring battle!");
...
const u8 gText_LevelCapRareCandy[] = _("{STR_VAR_1} was elevated to\nLv. {STR_VAR_2}.\p{STR_VAR_1} reached the LEVEL CAP!");
const u8 gText_LevelCapExpCandy[] = _("{STR_VAR_1} gained {STR_VAR_2} Exp. Points\nand was elevated to Lv. {STR_VAR_3}!\p{STR_VAR_1} reached the LEVEL CAP!");
...
const u8 gText_PkmnReachedLvlCap[] = _("{STR_VAR_1} has reached\nthe LEVEL CAP!");
...
const u8 gText_HPUp[] = _("HP UP");
const u8 gText_Protein[] = _("PROTEIN");
const u8 gText_Iron[] = _("IRON");
const u8 gText_Calcium[] = _("CALCIUM");
const u8 gText_Zinc[] = _("ZINC");
const u8 gText_Carbos[] = _("CARBOS");
const u8 gText_PPUp[] = _("PP UP");
...
const u8 gText_500CoinsAndPrice[] = _("500 COINS  ¥4,500");
...
const u8 gText_Softboiled16BP[] = _("SOFTBOILED{CLEAR_TO 0x4E}1BP");
const u8 gText_SeismicToss24BP[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}1BP");
const u8 gText_DreamEater24BP[] = _("DREAM EATER{CLEAR_TO 0x4E}1BP");
const u8 gText_MegaPunch24BP[] = _("MEGA PUNCH{CLEAR_TO 0x4E}1BP");
const u8 gText_MegaKick48BP[] = _("MEGA KICK{CLEAR_TO 0x4E}1BP");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 0x4E}1BP");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE{CLEAR_TO 0x4E}1BP");
const u8 gText_Counter48BP[] = _("COUNTER{CLEAR_TO 0x4E}1BP");
const u8 gText_ThunderWave48BP[] = _("THUNDER WAVE{CLEAR_TO 0x4E}1BP");
const u8 gText_SwordsDance48BP[] = _("SWORDS DANCE{CLEAR_TO 0x4E}1BP");
const u8 gText_DefenseCurl16BP[] = _("DEFENSE CURL{CLEAR_TO 0x4E}1BP");
const u8 gText_Snore24BP[] = _("SNORE{CLEAR_TO 0x4E}1BP");
const u8 gText_MudSlap24BP[] = _("MUD-SLAP{CLEAR_TO 0x4E}1BP");
const u8 gText_Swift24BP[] = _("SWIFT{CLEAR_TO 0x4E}1BP");
const u8 gText_IcyWind24BP[] = _("ICY WIND{CLEAR_TO 0x4E}1BP");
const u8 gText_Endure48BP[] = _("ENDURE{CLEAR_TO 0x4E}1BP");
const u8 gText_PsychUp48BP[] = _("PSYCH UP{CLEAR_TO 0x4E}1BP");
const u8 gText_IcePunch48BP[] = _("ICE PUNCH{CLEAR_TO 0x4E}1BP");
const u8 gText_ThunderPunch48BP[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}1BP");
const u8 gText_FirePunch48BP[] = _("FIRE PUNCH{CLEAR_TO 0x4E}1BP");
...
const u8 gText_Fight[] = _("FIGHT");
const u8 gText_DontFight[] = _("DON'T FIGHT");
