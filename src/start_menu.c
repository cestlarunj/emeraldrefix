...
static void ShowTimeWindow(void)
{
    ...
    ptr = ConvertIntToDecimalStringN(gStringVar4, gLocalTime.hours, STR_CONV_MODE_LEFT_ALIGN, 3);
    *ptr = 0xF0;

    ConvertIntToDecimalStringN(ptr + 1, gLocalTime.minutes, STR_CONV_MODE_LEADING_ZEROS, 2);
    
    AddTextPrinterParameterized(sStartClockWindowId, 1, timeofday, GetStringRightAlignXOffset(1, timeofday, CLOCK_WINDOW_WIDTH), 1, 0xFF, NULL);
