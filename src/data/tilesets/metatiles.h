...
const u16 gMetatiles_gTileset_PetalburgPlusForestEntry[] = INCBIN_U16("data/tilesets/secondary/petalburg_plus_forest_entry/metatiles.bin");
const u16 gMetatileAttributes_gTileset_PetalburgPlusForestEntry[] = INCBIN_U16("data/tilesets/secondary/petalburg_plus_forest_entry/metatile_attributes.bin");
