...
const u32 gTrainerFrontPic_Runj[] = INCBIN_U32("graphics/trainers/front_pics/runj.4bpp.lz");
const u32 gTrainerPalette_Runj[] = INCBIN_U32("graphics/trainers/front_pics/runj.gbapal.lz");
