...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    { ITEM_POTION,          {  10,   5,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_SUPER_POTION,    {   5,  10,   5,   5,   _,   _,   _,   _,   _,   _, } },
    { ITEM_HYPER_POTION,    {   _,   _,   5,   5,  10,   5,   _,   _,   _,   _, } },
    { ITEM_MAX_POTION,      {   _,   _,   _,   _,   _,   5,   5,   5,   _,   _, } },
    { ITEM_FULL_RESTORE,    {   5,   5,  10,  10,  10,  10,  10,   5,   5,   _, } },
    { ITEM_FULL_HEAL,       {   _,   _,   _,   _,   _,   _,   5,  10,  15,  20, } },
    { ITEM_POKE_BALL,       {  15,  10,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_GREAT_BALL,      {   5,  10,  10,   5,   _,   _,   _,   _,   _,   _, } },
    { ITEM_ULTRA_BALL,      {   _,   _,  10,  15,  20,  20,  20,  20,  15,  15, } },
    { ITEM_MASTER_BALL,     {   _,   _,   _,   _,   _,   _,   _,   _,   5,   5, } },
    { ITEM_REVIVE,          {  10,  10,  10,  10,   5,   5,   _,   _,   _,   _, } },
    { ITEM_MAX_REVIVE,      {   _,   _,   _,   _,   5,   5,  10,  10,  10,  10, } },
    { ITEM_PRETTY_FEATHER,  {  30,  25,  20,  20,  15,  10,   5,   5,   _,   _, } },
    { ITEM_NUGGET,          {   _,   _,   5,   5,   5,   5,   5,   5,   5,   5, } },
    { ITEM_HEART_SCALE,     {   _,   5,   5,  10,  10,  15,  20,  20,  25,  25, } },
    { ITEM_LUM_BERRY,       {  15,  10,   5,   5,   5,   5,   _,   _,   _,   _, } },
    { ITEM_MENTAL_HERB,     {   5,   5,   5,   5,   5,   5,   5,   _,   _,   _, } },
    { ITEM_POWER_HERB,      {   _,   5,   5,   5,   5,   5,   5,   5,   _,   _, } },
    { ITEM_WHITE_HERB,      {   _,   _,   5,   5,   5,   5,   5,   5,   5,   _, } },
    { ITEM_RARE_CANDY,      {   _,   _,   _,   _,   _,   _,   5,   5,   5,   5, } },
    { ITEM_PP_UP,           {   _,   _,   _,   _,   _,   _,   _,   5,   5,   5, } },
    { ITEM_LEFTOVERS,       {   _,   _,   _,   _,   _,   _,   _,   _,   5,   5, } },
    { ITEM_SACRED_ASH,      {   _,   _,   _,   _,   _,   _,   _,   _,   _,   5, } },
};
        ...
        if (gBattleControllerExecFlags == 0)
        {
             ...
             || GetMonData(&gPlayerParty[*expMonId], MON_DATA_SPECIES_OR_EGG) == SPECIES_EGG)
            {
                ...
                gBattleMoveDamage = 0; // used for exp
                  ...
                  || GetMonData(&gPlayerParty[*expMonId], MON_DATA_LEVEL) == MAX_LEVEL || levelCappedNuzlocke(GetMonData(&gPlayerParty[gBattleStruct->expGetterMonId], MON_DATA_LEVEL)))
            {
                gBattleScripting.getexpState = 5;
                gBattleMoveDamage = 0; // used for exp
